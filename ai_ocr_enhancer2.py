...
-----------------------------------
This script uses OpenAI's API to enhance and correct text extracted from PDFs and EPUBs.
...
class AiTextEnhancer:
    ...
    def enhance_text(self, text, context=None, is_ocr=True):
        """
        Enhance text using OpenAI to fix errors and improve readability.
    ...
    def _get_ocr_system_prompt(self, context, is_first_chunk):
        ...
        base_prompt = """
        You are an expert text corrector specializing in fixing OCR errors from scanned books and documents.
    ...
    def _get_epub_system_prompt(self, context, is_first_chunk):
        ...
        base_prompt = """
        You are an expert text editor working with digital book content.
